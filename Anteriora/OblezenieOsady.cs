...
namespace Anteriora
{
    public partial class OblezenieOsady : Form
    {
        // generator wrogów
        Osada o;
        ...
        List<JednostkiGracza> jednostkiWalczaceWreczLista = new List<JednostkiGracza>();
        List<JednostkiGracza> jednostkiWalczaceNaDystansLista = new List<JednostkiGracza>();
        ...
        List<PictureBox> pictureBoxMurLista = new List<PictureBox>();
        ...
        public OblezenieOsady(Osada c, Instancje instancja, ObszaryInstancji obszarInstancji)
        {
            o = c;
            ...
            #region dodanie buttonów do listy
            ...
            #endregion dodanie buttonów do listy
            ...
            o.piechur.pictureBox = pictureBoxPiechur;
            o.lucznik.pictureBox = pictureBoxLucznik;
            o.rycerz.pictureBox = pictureBoxWlocznik;
            o.czarnyRycerz.pictureBox = pictureBoxCzarnyRycerz;
            o.czarnyLucznik.pictureBox = pictureBoxCzarnyLucznik;
        ...
        #region Ruch jednostek po polach
        ...
        #endregion Ruch jednostek po polach
        ...
        {
            if (o.piechur.liczebnoscAtakujacych > 0)
            {
                jednostkiGraczaLista.Add(o.piechur);
                jednostkiWalczaceWreczLista.Add(o.piechur);
                UstawAtrybutyJednostkiGracza();
                numerRundyJednostki++;
            }          

            if (o.rycerz.liczebnoscAtakujacych > 0)
            {
                jednostkiGraczaLista.Add(o.rycerz);
                jednostkiWalczaceWreczLista.Add(o.rycerz);
                UstawAtrybutyJednostkiGracza();
                numerRundyJednostki++;
            }

            if (o.czarnyRycerz.liczebnoscAtakujacych > 0)
            {
                jednostkiGraczaLista.Add(o.czarnyRycerz);
                jednostkiWalczaceWreczLista.Add(o.czarnyRycerz);
                UstawAtrybutyJednostkiGracza();
                numerRundyJednostki++;
            }

            if (o.lucznik.liczebnoscAtakujacych > 0)
            {
                jednostkiGraczaLista.Add(o.lucznik);
                jednostkiWalczaceNaDystansLista.Add(o.lucznik);
                UstawAtrybutyJednostkiGracza();
                numerRundyJednostki++;
            }

            if (o.czarnyLucznik.liczebnoscAtakujacych > 0)
            {
                jednostkiGraczaLista.Add(o.czarnyLucznik);
                jednostkiWalczaceNaDystansLista.Add(o.czarnyLucznik);
                UstawAtrybutyJednostkiGracza();
                numerRundyJednostki++;
            }

            if (o.mur.pictureBox.Visible == true)
            {
                this.BackgroundImage = Properties.Resources.oblezeniemapka;

                pictureBoxMurLista.AddRange(new PictureBox[] { pictureBoxMur0, pictureBoxMur1, pictureBoxMur2, pictureBoxMur3, pictureBoxMur4, pictureBoxMur5, pictureBoxMur6 });

                foreach (var item in pictureBoxMurLista)
                {
                    item.Visible = true;
                }
                o.mur.ObliczWytrzymaloscBudowli();
                progressBarMur.Visible = true;
                progressBarMur.Maximum = o.mur.wytrzymałosc;
            }
            else
            {
                this.BackgroundImage = Properties.Resources.oblezeniemapkabezmuru;
                o.mur.wytrzymałosc = 0;
            }
        }
        ...
        public void MechanikaPrzeciwnik()
        {
            ...
            {
                if (jednostkiWalczaceWreczLista.Count > 0)
                {
                    foreach (var item in jednostkiWalczaceWreczLista)
                    {
                ...
                else if (o.mur.wytrzymałosc > 0)
                {
                    foreach (var item in pictureBoxMurLista)
                    {
                        if (przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.X == item.Location.X + 100 && przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.Y == item.Location.Y)
                        {
                            przeciwnicyLista[rundaPrzeciwnika].pictureBox.Image = przeciwnicyLista[rundaPrzeciwnika].obrazekLewo;
                    ...
                    foreach (var item in pictureBoxMurLista)
                    {
                        if (przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.Y == item.Location.Y && przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.X >= item.Location.X &&
                            przeciwnicyLista.Count(x => x.pictureBox.Location.X == przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.X - 100 && x.pictureBox.Location.Y == przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.Y) == 0)
                        {
                            przeciwnicyLista[rundaPrzeciwnika].pictureBox.Image = przeciwnicyLista[rundaPrzeciwnika].obrazekLewo;
                            przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location = new Point(przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.X - 100, przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.Y);
                ...
                else if(jednostkiWalczaceNaDystansLista.Count > 0)
                {
                    foreach (var item in jednostkiWalczaceNaDystansLista)
                    {
                        if (przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.X == item.pictureBox.Location.X + 100 && przeciwnicyLista[rundaPrzeciwnika].pictureBox.Location.Y == item.pictureBox.Location.Y)
                        {
                            przeciwnicyLista[rundaPrzeciwnika].pictureBox.Image = przeciwnicyLista[rundaPrzeciwnika].obrazekLewo;
        ...
        public void ZadajObrazeniaJednostceGracza(JednostkiGracza jednostka)
        {
            if (przeciwnicyLista[rundaPrzeciwnika].ObliczCalkowityAtak() >= jednostka.calkowitePZ)
            {
                ...
                o.mieszkancy.liczbaMieszkancow -= jednostka.liczebnoscAtakujacych;
                ...
                if(jednostka.czyAtakNaBliskiDystans == true)
                {
                    jednostkiWalczaceWreczLista.Remove(jednostka);
                }
                else if(jednostka.czyAtakNaBliskiDystans == false)
                {
                    jednostkiWalczaceNaDystansLista.Remove(jednostka);
                }
                    ...
                    else
                    {
                        ...
                        while (jednostka.PZ <= 0)
                        {
                            ...
                            if (jednostka.PZ > 0)
                            {
                                ...
                                o.mieszkancy.liczbaMieszkancow -= iloscZabitychJednostekGracza;
                                break;
                            }
                        }
                    }
        ...
        {
            if (jednostkiGraczaLista[rundaGracza].pictureBox.Location.X <= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.X && jednostkiGraczaLista[rundaGracza].pictureBox.Location.X >= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.X - 700 && ((jednostkiGraczaLista[rundaGracza].pictureBox.Location.Y >= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.Y - 700) && (jednostkiGraczaLista[rundaGracza].pictureBox.Location.Y <= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.Y + 700)))
            {
                jednostkiGraczaLista[rundaGracza].pictureBox.Image = jednostkiGraczaLista[rundaGracza].obrazekPrawo;
                przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.BackColor = Color.DarkRed;
                ZadajObrazeniaPrzeciwnikowi();
            }
            else if (jednostkiGraczaLista[rundaGracza].pictureBox.Location.X >= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.X && przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.X + 700 >= jednostkiGraczaLista[rundaGracza].pictureBox.Location.X && ((jednostkiGraczaLista[rundaGracza].pictureBox.Location.Y >= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.Y - 700) && (jednostkiGraczaLista[rundaGracza].pictureBox.Location.Y <= przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.Location.Y + 700)))
            {
                jednostkiGraczaLista[rundaGracza].pictureBox.Image = jednostkiGraczaLista[rundaGracza].obrazekLewo;
                przeciwnicyLista[ktoryPrzeciwnikMaZostacZaatakowany].pictureBox.BackColor = Color.DarkRed;
                ZadajObrazeniaPrzeciwnikowi();
        ...
        #region Zaatakuj mur i zadaj obrażenia

        public void ZaatakujMur()
        {
            if (przeciwnicyLista[rundaPrzeciwnika].ObliczCalkowityAtak() >= o.mur.wytrzymałosc)
            {
                this.BackgroundImage = Properties.Resources.oblezeniemapkabezmuru;
                o.mur.wytrzymałosc = 0;
                progressBarMur.Value = progressBarMur.Maximum;
                progressBarMur.ForeColor = Color.Black;
                labelMur.Text = "";
                labelMurPZ.Text = "0";
                foreach (var item in pictureBoxMurLista)
                {
            ...
            {
                o.mur.wytrzymałosc -= przeciwnicyLista[rundaPrzeciwnika].ObliczCalkowityAtak();
            }
        }

        #endregion Zaatakuj mur i zadaj obrażenia
        ...
        private void TimerGra_Tick(object sender, EventArgs e)
        {
            ...
            MechanikaPrzeciwnik();
            label23.Text = (rundaGracza + " " + rundaPrzeciwnika + " " + jednostkiGraczaLista.Count + " " + (jednostkiWalczaceWreczLista.FindAll(item => item.liczebnoscAtakujacych > 0).Count > 0)).ToString();
            progressBarMur.Value = o.mur.wytrzymałosc;
            labelMurPZ.Text = o.mur.wytrzymałosc.ToString();
            ...
            if (jednostkiGraczaLista.Count == 0 && o.mur.wytrzymałosc == 0)
            {
